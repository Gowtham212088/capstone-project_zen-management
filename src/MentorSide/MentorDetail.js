    ...
    <div className="container-fluid alert alert-primary profile-bg mt-5">
                             <div className="row mb-4 ">
                                ...
                                <div className="  d-flex justify-content-center align-items-center"> <h1 className="text-light"> Gowtham Kumar V </h1> </div> 
                                 ...
                                 <div className="col-sm-6 col-md-6 col-lg-6 d-flex justify-content-center align-items-center"> <i className="fa fa-github fa-border-none fa-4x text-secondary " aria-hidden="false"></i>   </div> 
                                 ...
                                 <div className="col-sm-6 col-md-6 col-lg-6  d-flex justify-content-center align-items-center"> <i className="text-primary fa fa-file-text fa-4x" aria-hidden="true"><br/> </i>   </div> 
                                 ...
                                 <div className="col-sm-6 col-md-6 col-lg-6  d-flex justify-content-center align-items-center"> <i className="fa fa-graduation-cap text-warning fa-4x" aria-hidden="true"></i>    </div> 
                                 ...
                                 <div className="col-sm-6 col-md-6 col-lg-6  d-flex justify-content-center align-items-center"> <i className="fa fa-envelope fa-4x text-danger" aria-hidden="true"></i> </div> 
                                 ...
                                 <div className="col-sm-6 col-md-6 col-lg-6  d-flex justify-content-center align-items-center"> <i className="fa fa-briefcase fa-4x text-info" aria-hidden="true"></i> </div> 
