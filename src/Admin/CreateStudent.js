...
const history = useHistory()
            ...
            <div className="row justify-content-center mt-5 ">
                ...
                <TextField type="email" id="standard-basic" error secondary label="Email" className="mb-5" variant="outlined" onChange={(event)=>setEmail(event.target.value)} />

                <TextField type="url" id="standard-basic" error secondary label="Image-URL" className="mb-5" variant="outlined" onChange={(event)=>setImage(event.target.value)} />

                <TextField type="password" id="standard-basic" error secondary label="Password" className="text-light mb-5" variant="outlined" onChange={(event)=>setPassword(event.target.value)} />
