...
<div className="d-flex justify-content-center"> <h1 style={{color:"rgb(123, 31, 162)"}}>  Sign In  </h1> </div>
        ...
        <div className="col-lg-6  d-flex justify-content-center page-2">
          ...
          <div className="d-flex justify-content-center"> <h1 style={{color:"rgb(123, 31, 162)"}}>  Sign Up  </h1> </div>
            ...
            <Button color="secondary" variant="contained" style={{ height: "45px",marginTop:"20px" }}>
              {" "}
              Sign Up{" "}
            </Button>
          </div>
