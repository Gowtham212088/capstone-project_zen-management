...
<div className="d-flex justify-content-center"> <h1 style={{color:"rgb(85, 0, 255)"}}>  Mentor Login  </h1> </div>
      ...
      <div className="col-lg-6  d-flex justify-content-center mentor-page-2">
        ...
        <div className="d-flex justify-content-center"> <h1 style={{color:"rgb(232, 0, 0)"}}> Register Mentorship  </h1> </div>
